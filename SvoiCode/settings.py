"""
Django settings for SvoiCode project.
...
SECRET_KEY = 'django-insecure-7+wv#q5@q#12w&ral5(p$&_-br-o6#5q-ldlhn@#6oh&=+5r2k'
...
WSGI_APPLICATION = 'SvoiCode.wsgi.application'
